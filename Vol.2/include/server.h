...
#define TICK_SEND 2        // (MAIN_TICK_MAX) - отправка пакета для проверки связи, (MAIN_TICK_MAX * 2) - отключение сокета
#define TICK_DROP 10
...
Message {
        /*
                ...
                7       удалить сервер из списка                        указатель на его данные
                8       упал обработчик игроков
        */
        unsigned char act;
        unsigned int uint;
        SLNode *node;
